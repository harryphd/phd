...
class Iteration:
    ...
    def Iterate(self, GPDParams, taus, Z, T, K, xi_sig, scale_sig, pri_delt, pri_nu, pri_kappa, pri_alpha, pri_beta, DataMat, oldZ):
        ...
        GPDParams, updated_GPD, loglike = GPDGen.Update_GPD_Iterator(taus, Z, GPDParams, xi_sig, scale_sig, pri_nu, pri_kappa, pri_alpha, pri_beta, DataMat)
        ...
        return taus, GPDParams, Z, tot_alp, updated_GPD, oldZ, updated_Dim, loglike